...
class AdminUsersListWidget extends StatefulWidget {
  ...
  static String routeName = 'admin_users_list';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          final users = adminUsersListUsersRecordList
                              .toList()
                              .take(20)
                              .toList();
                            ...
                            itemBuilder: (context, usersIndex) {
                              ...
                              return Align(
                                ...
                                child: FutureBuilder<int>(
                                  future: queryRecyclingActionRecordCount(
                                    queryBuilder: (recyclingActionRecord) =>
                                        recyclingActionRecord.where(
                                      'email',
                                      isEqualTo: usersItem.email,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              StreamBuilder<
                                                  List<RecyclingActionRecord>>(
                                                stream:
                                                    queryRecyclingActionRecord(
                                                  queryBuilder:
                                                      (recyclingActionRecord) =>
                                                          recyclingActionRecord
                                                              .where(
                                                    'email',
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<RecyclingActionRecord>
                                                      userActionsCountRecyclingActionRecordList =
                                                      snapshot.data!;
