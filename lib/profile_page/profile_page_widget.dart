  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ChallengesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChallengesRecord> profilePageChallengesRecordList = snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<List<UserChallengesRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<UserChallengesRecord>
                                            listViewUserChallengesRecordList =
                                            snapshot.data!;
                                        if (listViewUserChallengesRecordList
                                            .isEmpty) {
                                          return Image.asset(
                                            'assets/images/New_Project_(4).png',
                                          );
                                        }
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewUserChallengesRecord =
                                                listViewUserChallengesRecordList[
                                                    listViewIndex];
                                            return Padding(
