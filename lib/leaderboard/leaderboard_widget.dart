                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final users = leaderboardUsersRecordList
                                  .toList()
                                  .take(3)
                                  .toList();
                            ...
                            child: Transform.translate(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    context.pushNamed(
                                        CompleteLeaderboardWidget.routeName);
                                  },
                                ),
                              ),
                            ),
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final users = leaderboardUsersRecordList.toList();
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, usersIndex) {
                                  ...
                                  return Visibility(
                                    visible:
                                        (usersItem.email == currentUserEmail) &&
                                            (usersIndex > 2),
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 15.0),
